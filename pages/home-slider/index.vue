<template>
  <div
    class="main-slider"
    style="max-width: 1168px; height: 304px"
    ...
    <transition name="fade" mode="out-in">
      <div v-if="!loading">
        ...
        <p style="color: red; margin-top: 5px">
          * Image should be (868px x 304px)
        </p>
        <!--left-->
        <div class="right">
          <div style="height: 100%" class="img-wrap">
            <template v-if="result.right_top">
              <img :src="getImageURL(result.right_top.image)" alt="" />
