<template>
  <div class="inline-pop-wrapper" v-outside-click="closePop">
    <button @click.prevent="togglePop">
      <slot name="button" />
      <i
        v-if="arrow"
